 ...
 * @protected
 *
 * @properties={typeid:35,uuid:"27B5F276-F6CE-4431-A762-B406653641DA",variableType:4}
 */
var toggleMustExecuteOnFocusGained = 1;
 ...
 * @param event
 *
 * @properties={typeid:24,uuid:"16615BD2-85A0-44A3-9F14-4C6F9C02B107"}
 */
function requestFocus(event) {
	if (testElement) {
		elements[testElement].requestFocus(toggleMustExecuteOnFocusGained === 1)
	}
}
 ...
 * @param {JSEvent} event
 *
 * @properties={typeid:24,uuid:"E3FB7267-4A8A-44BA-8C9F-AC056D4D860A"}
 */
function showFormPopupMenu(event) {
	scopes.svyWebComponentsModel.showFormPopupMenu(event);
	return;
}
 ...
 * @param {JSEvent} event
 *
 * @properties={typeid:24,uuid:"21FF8813-776B-43EE-95E2-59FA3BB75E8E"}
 */
function showElementPopupMenu(event) {
	scopes.svyWebComponentsModel.showElementPopupMenu(event);
	return;
}
 ...
 * @public   
 *
 * @properties={typeid:24,uuid:"672DE839-0E2B-4DBB-8C4C-A802F317227D"}
 */
function getLocation(event) {
	var x = elements[testElement].getLocationX();
	var y = elements[testElement].getLocationY();
	log("Element " + testElement + " location X: " + x + " Y: " + y);
}
 ...
 * @public   
 *
 * @properties={typeid:24,uuid:"934AB304-6763-4865-BB73-04BDF9B58B44"}
 */
function getSize(event) {
	var h = elements[testElement].getHeight();
	var w = elements[testElement].getWidth();
	log("Element " + testElement + " location height " + h + " width " + w);
}